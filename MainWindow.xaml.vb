...
''' Art, Spectrum, Visualizer, Graphic Equalizer, Playlist) as a dockable/floatable AvalonDock pane.
''' Cassette itself still creates and owns all the other panels and holds every bit of
''' playback/recording/animation logic exactly as before - this window's only job is placing each
''' of Cassette's panels into its own LayoutAnchorable and cleaning up on exit.</summary>
Class MainWindow
